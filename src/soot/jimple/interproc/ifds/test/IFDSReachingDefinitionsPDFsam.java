...
public class IFDSReachingDefinitionsPDFsam {
				...
				if (handler != null) {
					...
					for (int i = 0; i < handler.getPhaseCount(); i++) {
						...
						IFDSTabulationProblem<UpdatableWrapper<Unit>, UpdatableReachingDefinition, UpdatableWrapper<SootMethod>,
							...
							new IFDSReachingDefinitions(icfg = new UpdatableJimpleBasedInterproceduralCFG());
						IFDSSolver<UpdatableWrapper<Unit>,UpdatableReachingDefinition,UpdatableWrapper<SootMethod>,
						...
						solver2.solve();
						System.out.println("Update done in "
								+ (System.nanoTime() - beforeSolve) / 1E9 + " seconds.");
						if (handler != null)
