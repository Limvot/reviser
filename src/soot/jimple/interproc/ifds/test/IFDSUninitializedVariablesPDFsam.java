...
public class IFDSUninitializedVariablesPDFsam {
	...
	private abstract class DynamicTestHandler implements ITestHandler<UpdatableWrapper<Local>> {
				...
				if (handler != null) {
					...
					for (int i = 0; i < handler.getPhaseCount(); i++) {
						...
						IFDSTabulationProblem<UpdatableWrapper<Unit>, UpdatableWrapper<Local>, UpdatableWrapper<SootMethod>,
							...
							new IFDSUninitializedVariables(icfg = new UpdatableJimpleBasedInterproceduralCFG());
						IFDSSolver<UpdatableWrapper<Unit>,UpdatableWrapper<Local>,UpdatableWrapper<SootMethod>,
...
//				"-pp",
	...
	private ITestHandler<UpdatableWrapper<Local>> ITestHandlerNewVersion() {
